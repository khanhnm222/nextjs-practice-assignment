    ...
    <div className="relative mx-auto mb-16 px-6 md:max-w-2xl lg:max-w-5xl lg:px-12">
      <div className="relative z-10 mx-auto text-center">
        ...
        <a href="/" aria-label="go back home" className="relative mx-auto flex h-11 w-11 items-center justify-center before:absolute before:inset-0 before:rounded-full before:bg-gray-300 before:shadow-2xl before:shadow-primary dark:shadow-none dark:before:bg-gray-700 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="relative w-5 h-5 text-primary dark:text-white">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"></path>
          </svg>
        </a>
      </div>
      <div aria-hidden="true" className="absolute left-8 w-40 -rotate-45 h-64 rounded-full -top-16 bg-gradient-to-r from-green-400 via-primaryLight to-purple-400 blur-2xl opacity-60 dark:from-primary/40 dark:via-sky-900 dark:to-indigo-900 dark:opacity-40"></div>
    </div>
  )
}
